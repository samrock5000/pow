...
import { createCompilerCommon, hexToBin, stringify, stringifyTestVector, walletTemplateP2pkh, walletTemplateP2pkhNonHd, walletTemplateToCompilerConfiguration, } from '../lib.js';
...
test('walletTemplateToCompilerConfiguration: walletTemplateP2pkh', (t) => {
    const configuration = walletTemplateToCompilerConfiguration(walletTemplateP2pkh);
    t.deepEqual(configuration, {
        entityOwnership: {
            key: 'owner',
        },

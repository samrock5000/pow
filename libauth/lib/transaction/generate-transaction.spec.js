...
import { CashAddressNetworkPrefix, decodeTransaction, generateTransaction, hexToBin, importWalletTemplate, lockingBytecodeToCashAddress, walletTemplateToCompilerBCH, } from '../lib.js';
const maybeP2pkhTemplate = {
    entities: {
        ownerEntity: {
            name: 'Owner',
            scripts: ['lock', 'unlock'],
...
//# sourceMappingURL=generate-transaction.spec.js.map
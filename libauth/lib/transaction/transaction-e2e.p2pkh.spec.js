...
import { CashAddressNetworkPrefix, decodeTransactionCommon, generateTransaction, hexToBin, importWalletTemplate, lockingBytecodeToCashAddress, walletTemplateToCompilerBCH, } from '../lib.js';
import { hdPrivateKey, hdPublicKey, p2pkhJson, } from './transaction-e2e.spec.helper.js';
test('transaction e2e tests: P2PKH (walletTemplateP2pkhHd)', (t) => {
    ...
    t.deepEqual(lockingBytecodeToCashAddress(lockingBytecode.bytecode, CashAddressNetworkPrefix.testnet), 'bchtest:qq2azmyyv6dtgczexyalqar70q036yund53jvfde0x');
    const utxoOutpointTransactionHash = hexToBin('68127de83d2ab77d7f5fd8d2ac6181d94473c0cbb2d0776084bf28884f6ecd77');

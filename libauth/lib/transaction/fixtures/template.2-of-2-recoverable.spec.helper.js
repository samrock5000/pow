...
export const twoOfTwoRecoverable = {
    ...
    entities: {
        signer_1: {
            ...
            variables: {
                ...
                first: { name: "Signer 1's HdKey", type: 'HdKey' },
            },
        },
        signer_2: {
            ...
            variables: { second: { name: "Signer 2's HdKey", type: 'HdKey' } },
        },
        trusted_party: {
    ...
    scenarios: {
        after_recovery_time: {
            ...
            transaction: {
                locktime: CompilerDefaults.defaultScenarioCurrentBlockTime +
                    secondsIn30Days,
            },
        },
...
//# sourceMappingURL=template.2-of-2-recoverable.spec.helper.js.map
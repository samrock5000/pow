...
import { compilerConfigurationToCompilerBCH, compilerOperationsBCH, createAuthenticationProgramEvaluationCommon, createCompilationContextCommonTesting, createVirtualMachineBCH, generateBytecodeMap, OpcodesBCH2022, ripemd160, secp256k1, sha256, sha512, stringifyTestVector, } from '../../lib.js';
/**
 * `m`
 */
 ...
 */
export const expectCompilationResult = test.macro((t, testScript, otherData, expectedResult, variables, configurationOverrides) => {

...
import { binToHex, hexToBin, isHex, range, splitEvery, swapEndianness, } from '../lib.js';
...
testProp('[fast-check] hexToBin <-> binToHex', [fc.uint8Array({ maxLength: 100, minLength: 0 })], (t, input) => t.deepEqual(binToHex(hexToBin(binToHex(input))), binToHex(input)));

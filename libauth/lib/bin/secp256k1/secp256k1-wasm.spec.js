...
import { CompressionFlag, ContextFlag, getEmbeddedSecp256k1Binary, instantiateSecp256k1Wasm, instantiateSecp256k1WasmBytes, } from '../../lib.js';
...
const testSecp256k1Wasm = (t, secp256k1Wasm) => {
    ...
    t.is(secp256k1Wasm.schnorrSign(contextPtr, schnorrSigPtr, schnorrMsgHashPtr, privkeyPtr), 1);
    t.deepEqual(secp256k1Wasm.readHeapU8(schnorrSigPtr, 64), sigSchnorr);
    // verify the schnorr signature
    t.is(secp256k1Wasm.schnorrVerify(contextPtr, schnorrSigPtr, schnorrMsgHashPtr, rawPubkeyPtr), 1);
};
...
//# sourceMappingURL=secp256k1-wasm.spec.js.map
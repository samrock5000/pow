...
import { CashAddressNetworkPrefix, compileCashAssembly, createVirtualMachineBCH, dateToLocktime, decodeTransactionCommon, encodeTransactionCommon, extractMissingVariables, generateTransaction, hexToBin, importWalletTemplate, lockingBytecodeToCashAddress, stringify, walletTemplateToCompilerBCH, } from '../lib.js';
import { hdPrivateKey0H, hdPrivateKey1H, hdPrivateKey2H, hdPublicKey0H, hdPublicKey1H, hdPublicKey2H, twoOfTwoRecoverableJson, } from './transaction-e2e.spec.helper.js';
...
test('transaction e2e tests: 2-of-2 Recoverable Vault', (t) => {
    ...
    const creationDate = dateToLocktime(new Date('2020-01-01T00:00:00.000Z'));
    const threeMonths = 60 * 60 * 24 * 90;
    const locktimeFourMonthsLater = dateToLocktime(new Date('2020-04-01T00:00:00.000Z'));
    const lockingData = {
        bytecode: {
            delay_seconds: compileCashAssembly(`${threeMonths}`),
        },
    ...
    const input1 = {
        outpointIndex: 0,
        outpointTransactionHash: hexToBin('6168cbf5d24784df4fef46e1e5cfacaee14cda4c29dd8114b9cfc44972aea46a'),
        sequenceNumber: 0,
        unlockingBytecode: {
            compiler,
            script: 'spend',
            valueSatoshis: utxoOutput1.valueSatoshis,
        },
    };
    /**
    ...
    const input2 = {
        outpointIndex: 1,
        outpointTransactionHash: hexToBin('0ce50e17e71dadd8ba59e89a291cf3082862b32b229c5fbfc8dee3288165d97c'),
        sequenceNumber: 0,
        unlockingBytecode: {
            compiler,
            script: 'recover_1',
            valueSatoshis: utxoOutput2.valueSatoshis,
        },
    };
    ...
    const expectedSigner1SignatureInput1 = hexToBin('304402200a34f3387a8aa3d7ed55506fbddb6957e27cc42063410306ac82e7a77f4d7030022065b08d5a07fac82d1cd6c90ff126f1af965e541525676538eab088b99daa897b41');
    ...
    const signer2Attempt2MissingVariables = extractMissingVariables(signer2Attempt2);
    ...
    t.deepEqual(signer2Attempt2.completions, [
        {
            ...
            input: {
                ...input1,
                unlockingBytecode: hexToBin(''),
            },
            type: 'input',
        },
    ], stringify(signer2Attempt2.completions));
    const completedInput1 = signer2Attempt2.completions[0].input;
    /**
    ...
    }, `${stringify(successfulCompilation)} - ${stringify(encodeTransactionCommon(successfulCompilation.transaction))}`);
});

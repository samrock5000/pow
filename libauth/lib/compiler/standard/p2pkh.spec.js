...
import { importWalletTemplate, walletTemplateP2pkh, walletTemplateP2pkhNonHd, } from '../../lib.js';
...
test('walletTemplateP2pkh is mostly equivalent to walletTemplateP2pkhHd', (t) => {
    ...
    t.deepEqual(walletTemplateP2pkhNonHd.supported, walletTemplateP2pkh.supported);

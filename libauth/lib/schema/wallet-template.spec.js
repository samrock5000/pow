...
test.failing('must be an object', testValidation, 'a string', 'A valid wallet template must be an object.');
test.failing('must be version 0', testValidation, { version: 1 }, 'Only version 0 wallet templates are currently supported.');
test.failing('must provide a "supported" property', testValidation, { supported: 42, version: 0 }, 'Version 0 wallet templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
test.failing('must use only known virtual machine identifiers in "supported"', testValidation, { supported: ['not supported'], version: 0 }, 'Version 0 wallet templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
test.failing('may not have empty items in "supported"', testValidation, 
// eslint-disable-next-line no-sparse-arrays
{ supported: ['BCH_2020_05', , 'BCH_2020_11_SPEC'], version: 0 }, 'Version 0 wallet templates must include a "supported" list of authentication virtual machine versions. Available identifiers are: BCH_SPEC, BCH_2022_11, BCH_2022_05_SPEC, BCH_2022_05, BCH_2021_11_SPEC, BCH_2021_11, BCH_2021_05_SPEC, BCH_2021_05, BCH_2020_11_SPEC, BCH_2020_11, BCH_2020_05, BCH_2019_11, BCH_2019_05, BSV_2018_11, BTC_2017_08.');
test.failing('"$schema" must be a string (if present)', testValidation, { $schema: 42, supported: ['BCH_SPEC'], version: 0 }, 'The "$schema" property of a wallet template must be a string.');
test.failing('"name" must be a string (if present)', testValidation, { name: 42, supported: ['BCH_SPEC'], version: 0 }, 'The "name" property of a wallet template must be a string.');
test.failing('"description" must be a string (if present)', testValidation, { description: 42, supported: ['BCH_SPEC'], version: 0 }, 'The "description" property of a wallet template must be a string.');
test.failing('"entities" must be a an object', testValidation, { entities: 42, scripts: {}, supported: ['BCH_SPEC'], version: 0 }, 'The "entities" property of a wallet template must be an object.');
test.failing('"scripts" must be a an object', testValidation, { entities: {}, scripts: 42, supported: ['BCH_SPEC'], version: 0 }, 'The "scripts" property of a wallet template must be an object.');
test.failing('"scenarios" must be a an object (if present)', testValidation, {
    entities: {},
    scenarios: 42,
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('script shapes are checked', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: 42 },
    supported: ['BCH_SPEC'],
...
test.failing('empty script object', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: {} },
    supported: ['BCH_SPEC'],
...
test.failing('unlocking script, no content', testValidation, {
    entities: {},
    scenarios: {},
    scripts: { a: { unlocks: 'b' } },
    supported: ['BCH_SPEC'],
...
test.failing('unlocking script, invalid unlocks', testValidation, {
    entities: {},
    scenarios: {},
...
test.failing('unknown locking script', testValidation, {
    entities: {},
    scenarios: {},
...
test.failing('unlocking script, invalid timeLockType', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid ageLock', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid estimate', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, empty passes item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        // eslint-disable-next-line no-sparse-arrays
...
test.failing('unlocking script, non-string fails item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('unlocking script, non-string invalid item', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('unlocking script, valid ageLock', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('locking script, no type', testValidation, {
    entities: {},
    scenarios: {},
...
test.failing('locking script, no contents', testValidation, {
    entities: {},
    scenarios: {},
...
test.failing('locking script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', unlocks: 'b' },
...
test.failing('tested script, no contents', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { tests: [] },
...
test.failing('tested script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid tests', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: 42 },
...
test.failing('tested script, test with no check', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: { script: '', tests: [{ name: '' }] },
...
test.failing('tested script, invalid test name', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid test setup', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid passes', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid fails', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid "invalid"', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('tested script, invalid pushed', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test('tested script, valid test', testValidation, {
    entities: {},
    scenarios: { s1: {}, s2: {}, s3: {} },
    scripts: {
        a: {
...
test.failing("tested script, can't test a locking script", testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
...
test.failing('other script, invalid name', testValidation, {
    entities: {},
    scenarios: {},
...
test.failing('invalid entity', testValidation, {
    entities: { e: 42 },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_SPEC'],
...
test.failing('invalid entity description', testValidation, {
...
test.failing('invalid entity name', testValidation, {
    entities: { e: { name: 42 } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_SPEC'],
...
test.failing('invalid entity scripts', testValidation, {
    entities: { e: { scripts: '' } },
    scenarios: {},
    scripts: { a: { script: '' } },
    supported: ['BCH_SPEC'],
...
test.failing('invalid entity scripts items', testValidation, {
    // eslint-disable-next-line no-sparse-arrays
...
test.failing('invalid entity variables', testValidation, {
...
test.failing('variable, wrong type', testValidation, {
...
test.failing('variable, no type', testValidation, {
...
test.failing('variable, invalid description', testValidation, {
    entities: {
...
test.failing('variable, invalid name', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid addressOffset', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid hdPublicKeyDerivationPath', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid privateDerivationPath', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid publicDerivationPath', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid privateDerivationPath content', testValidation, {
    entities: {
...
test.failing('HdKey variable, invalid hdPublicKeyDerivationPath content', testValidation, {
    entities: {
        e: {
...
test.failing('HdKey variable, invalid publicDerivationPath content', testValidation, {
    entities: {
        e: {
...
test.failing('HdKey variable, invalid implied private derivation path', testValidation, {
    entities: {
        e: {
            variables: {
                v: {
...
test('AddressData variable, valid', testValidation, {
...
test('HdKey variable, valid', testValidation, {
    entities: {
        e: {
            variables: {
                v: {
...
test.failing('Scenario, invalid type', testValidation, {
    entities: {},
    scenarios: { a: '' },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid name', testValidation, {
    entities: {},
    scenarios: { a: { name: 1 } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid description', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid extends', testValidation, {
    entities: {},
...
test.failing('Scenario, unknown extends', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid value (negative)', testValidation, {
    entities: {},
    scenarios: { a: { value: -1 } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid value (greater than Number.MAX_SAFE_INTEGER)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid value (insufficient hex)', testValidation, {
    entities: {},
    scenarios: { a: { value: '' } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test('Scenario, value (hex)', testValidation, {
    entities: {},
    scenarios: {
...
test.failing('Scenario, invalid data', testValidation, {
    entities: {},
    scenarios: { a: { data: '' } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test('Scenario, empty data', testValidation, {
    entities: {},
    scenarios: { a: { data: {} } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid bytecode', testValidation, {
    entities: {},
...
test('Scenario, valid bytecode', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid currentBlockHeight (string)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid currentBlockHeight (negative)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid currentBlockHeight (decimal)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid currentBlockHeight (exceeds maximum)', testValidation, {
    entities: {},
...
test('Scenario, valid currentBlockHeight', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid currentBlockTime (below minimum)', testValidation, {
    entities: {},
...
test('Scenario, valid currentBlockTime', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.addressIndex (string)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.addressIndex (negative)', testValidation, {
    entities: {},
    scenarios: { a: { data: { hdKeys: { addressIndex: -1 } } } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid data.hdKeys.addressIndex (decimal)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.addressIndex (exceeds maximum)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.hdPublicKeys', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.hdPublicKeys (non-string value)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.hdPrivateKeys', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.hdKeys.hdPrivateKeys (non-string value)', testValidation, {
    entities: {},
...
test('Scenario, valid data.hdKeys', testValidation, {
    entities: { e: {}, f: {} },
    scenarios: {
        a: {
            data: {
...
test.failing('Scenario, invalid data.keys', testValidation, {
    entities: {},
...
test('Scenario, empty data.keys', testValidation, {
    entities: {},
    scenarios: { a: { data: { keys: {} } } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid data.keys.privateKeys', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid data.keys.privateKeys (non-string value)', testValidation, {
    entities: {},
...
test('Scenario, valid data.keys', testValidation, {
    entities: {},
    scenarios: {
        a: {
            data: {
...
test.failing('Scenario, invalid transaction', testValidation, {
    entities: {},
...
test('Scenario, empty transaction', testValidation, {
    entities: {},
    scenarios: { a: { transaction: {} } },
    scripts: {},
    supported: ['BCH_SPEC'],
...
test.failing('Scenario, invalid transaction.locktime', testValidation, {
    entities: {},
...
test('Scenario, valid transaction.locktime', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid transaction.version', testValidation, {
    entities: {},
...
test('Scenario, valid transaction.version', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid transaction.inputs (no inputs)', testValidation, {
    entities: {},
...
test.failing('Scenario, invalid transaction.inputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
test.failing('Scenario, invalid transaction input outpointIndex (negative)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction input outpointTransactionHash (non-string)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction input outpointTransactionHash (incorrect length)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction input sequenceNumber', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction input unlockingBytecode', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, valid transaction.inputs', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, empty transaction.outputs', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction.outputs (sparse array)', testValidation, {
    entities: {},
    scenarios: {
        // eslint-disable-next-line no-sparse-arrays
...
test.failing('Scenario, invalid transaction output lockingBytecode type', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction output lockingBytecode (non-hex)', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction output lockingBytecode.script', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction output lockingBytecode.override', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('Scenario, invalid transaction output satoshis', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test('Scenario, valid transaction output', testValidation, {
    entities: {},
    scenarios: {
        a: {
            transaction: {
...
test.failing('built-in identifiers may not be re-used', testValidation, {
...
test.failing('all IDs must be unique', testValidation, {
    entities: { a: {}, b: {}, d: {} },
    scenarios: { b: {} },
...
test.failing('all entity script IDs must exist', testValidation, {
...
test.failing('all scenarios reference by scripts must exist', testValidation, {
    entities: {},
    scenarios: {},
    scripts: {
        a: {
...
test.failing('all entities referenced by data.hdKeys must exist', testValidation, {
    entities: { a: {}, b: {} },
    scenarios: {
        s: {
            data: {
...
//# sourceMappingURL=wallet-template.spec.js.map
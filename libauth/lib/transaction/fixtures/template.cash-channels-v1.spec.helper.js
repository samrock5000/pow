export const cashChannels = {
    ...
    scenarios: {
        ...
        exceeds_maximum_payment_number: {
            ...
            description: 'An example scenario where the payment number exceeds the maximum uint16 value.',
            name: 'Payment Number Exceeds Maximum',
        },
        test_bytecode_values: {
            description: "A scenario for testing all bytecode values. Because this scenario doesn't require compiling the script under test for its outputs, errors are a little easier to debug.",
    ...
    scripts: {
        ...
        covered_bytecode_after_payment_number: {
            ...
            tests: {
                check_bytecode: {
                    check: '<>\nOP_EQUAL',
                    name: 'Check Bytecode',
        ...
        covered_bytecode_before_payment_number: {
            ...
            tests: {
                check_bytecode: {
                    check: '<0x210279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f817987c63766b56795f795779765c79a26958805779588057795880577958807e7e766b7e7e7e7cbbb16d6d587902>\nOP_EQUAL',
                    name: 'Check Bytecode',
                    passes: ['test_bytecode_values'],
                },
            },
        ...
        payment_authorization: {
            ...
            tests: {
                check_format: {
                    check: '<0x564752b9f1c9f0246c8444a7f0a0ee8348f2e33902000429000000000000e803000000000000555344000000000080bf345e00000000>\nOP_EQUAL',
                    name: 'Check Format',
        ...
        payment_number_padded: {
            ...
            tests: {
                is_2_bytes: {
                    check: 'OP_SIZE <2> OP_EQUALVERIFY\nOP_BIN2NUM <payment_number>\nOP_EQUAL',
...
//# sourceMappingURL=template.cash-channels-v1.spec.helper.js.map
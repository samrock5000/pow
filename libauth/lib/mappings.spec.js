...
import { AuthenticationErrorBCH, AuthenticationErrorBCH2023, cloneAuthenticationProgramState, cloneAuthenticationProgramStateBCH, cloneAuthenticationProgramStateCommon, compilerConfigurationToCompiler, compilerConfigurationToCompilerBCH, ConsensusBCH, ConsensusCommon, createCompiler, createCompilerBCH, createInstructionSetBCH, createInstructionSetBCH2023, createVirtualMachineBCH, createVirtualMachineBCH2023, decodeTransaction, decodeTransactionBCH, decodeTransactionCommon, decodeTransactionUnsafe, decodeTransactionUnsafeBCH, decodeTransactionUnsafeCommon, encodeTransaction, encodeTransactionBCH, encodeTransactionCommon, OpcodeDescriptions, OpcodeDescriptionsBCH, OpcodeDescriptionsBCH2023, Opcodes, OpcodesBCH, OpcodesBCH2023, SigningSerializationType, SigningSerializationTypeBCH, } from './lib.js';
...
test('Libauth exposes all expected mappings', (t) => {
    const testTypes = true;
    t.true(testTypes);
    t.deepEqual(AuthenticationErrorBCH2023, AuthenticationErrorBCH);
    t.deepEqual(cloneAuthenticationProgramStateCommon, cloneAuthenticationProgramStateBCH);
    t.deepEqual(cloneAuthenticationProgramState, cloneAuthenticationProgramStateBCH);
    t.deepEqual(compilerConfigurationToCompilerBCH, compilerConfigurationToCompiler);
...
//# sourceMappingURL=mappings.spec.js.map
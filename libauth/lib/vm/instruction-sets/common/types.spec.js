...
import { bigIntToVmNumber, binToHex, booleanToVmNumber, hexToBin, stackItemIsTruthy, VmNumberError, vmNumberToBigInt, } from '../../../lib.js';
// Derived from https://github.com/bitcoinjs/bitcoinjs-lib
const minimallyEncodedVmNumbers = [
...
const nonMinimallyEncodedVmNumbers = [
    ['00', 0n],
    ['0000', 0n],
    ['80', 0n],
    ['0080', 0n],
...
test('decodeVmNumber', (t) => {
    minimallyEncodedVmNumbers.map((pair) => {
        ...
        t.deepEqual(vmNumberToBigInt(hexToBin(pair[0]), {
    ...
    [...minimallyEncodedVmNumbers, ...nonMinimallyEncodedVmNumbers].map((pair) => {
        t.deepEqual(vmNumberToBigInt(hexToBin(pair[0]), {
    ...
    t.deepEqual(vmNumberToBigInt(hexToBin('abcdef1234'), {
        maximumVmNumberByteLength: 4,

...
testProp('[fast-check] binStringToBin <-> binToBinString', [fc.uint8Array({ maxLength: 100, minLength: 0 })], (t, input) => t.deepEqual(binToBinString(binStringToBin(binToBinString(input))), binToBinString(input)));
